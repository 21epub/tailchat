...
export const GroupPluginPanel2: React.FC<TextPanelProps> = React.memo(
  ({ groupId, panelId }) => {
    ...
    if (isGroupPlugin) {
      pluginCustomPanel
        ...
        .map((p) => {
          console.log('[Group]pluginCustomPanel', p.name, panelId);
          if (p.name == panelId) {
            ret = (
...
GroupPluginPanel2.displayName = 'GroupPluginPanel2';
